...
//            startActivity(launchIntent)
    ...
    open fun launchVipps(context: MainActivity, amount: Double, orderId: Int, activity: MainActivity) {
        try {
...
//            context.startActivity(storeIntent);
    ...
    val vippsDeepLinkUrl = "vipps://login?client_id=<YOUR_CLIENT_ID>&redirect_uri=<YOUR_REDIRECT_URI>&scopes=<REQUESTED_SCOPES>"
    ...
    fun initiateVippsLogin(context: MainActivity) {
        val vippsDeepLinkUrl = "vipps://login?client_id=<YOUR_CLIENT_ID>&redirect_uri=vipps_payment&scopes=<REQUESTED_SCOPES>"
