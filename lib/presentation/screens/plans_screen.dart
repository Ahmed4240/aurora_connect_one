...
class PlansScreen extends StatelessWidget {
                              ...
                              Container(
                                ...
                                child: ListView.builder(
                                    ...
                                    itemCount: controller
                                        .localPlansResponse.data?.length,
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Column(
                                                          ...
                                                          children: [
                                                            Text(
                                                                "${controller.localPlansResponse.data?[index].price} \$",
                                                                style: const TextStyle(
                                                                    color: Colors
                                                                        .black,
                                                                    fontSize:
  ...
  void openPlanDetails(BuildContext context, PlanDetail model) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => PlanDetailsScreen(model: model),
      ),
    );
  }
}
