                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  controller.accountInfoResponse.value.data?.name ?? '---',
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  controller.accountInfoResponse.value.data?.phone ?? '',
                                  style: const TextStyle(
                                      color: Colors.grey,
                                      fontFamily: 'Metropolis',
                                      fontWeight: FontWeight.w400,
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  controller.accountInfoResponse.value.data?.email ?? '',
                                  style: const TextStyle(
                                      color: Colors.grey,
                                      fontFamily: 'Metropolis',
                                      fontWeight: FontWeight.w400,
                        ...
                        Visibility(
                          visible: controller.accountInfoResponse.value.data?.workEmail != null,
                          child: Card(
                            margin: const EdgeInsets.only(
                                top: 5, bottom: 5, left: 15, right: 15),
                            elevation: 5,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        controller.accountInfoResponse.value.data?.workEmail ?? '',
                                        style: const TextStyle(
                                            color: Colors.grey,
                                            fontFamily: 'Metropolis',
                                            fontWeight: FontWeight.w400,
